...
export const Historia = () => {
    return (
        <div>
            <article className="ourhistory container-fluid">
              <div className="container">
                <h2 className="historytitle">Nuestra historia</h2>
                    <p>Existe una pregunta por la solidaridad entre lo vivo que, formulada por cada uno de los integrantes de <span>CAPIBARA</span>, luego, no sólo nos permitió encontrarnos sino que se convirtió en el núcleo de un espacio de intercambio colectivo.
